...
function command.run(message, mt)
  ...
  _G['giftedmessage'] = formatstring(lang.gifted_message, {numitems, cdb[curfilename].name, uj2.id}, isplural)
  _G['recievedmessage'] = formatstring(lang2.recieved_message, {uj.id, numitems, cdb[curfilename].name}, isplural2)
